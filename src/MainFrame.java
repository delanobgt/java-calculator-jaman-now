...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void pnlTitleMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnlTitleMouseReleased
        diffX = -1;
        diffY = -1;
    }//GEN-LAST:event_pnlTitleMouseReleased
    ...
    private void calcBtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calcBtnMouseEntered
        JLabel calcBtn = (JLabel)evt.getSource();
        calcBtn.setBackground(new Color(15, 176, 176));
    }//GEN-LAST:event_calcBtnMouseEntered
    private void calcBtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_calcBtnMouseExited
        JLabel calcBtn = (JLabel)evt.getSource();
...
//            calcBtn.setBackground(new Color(17, 214, 214));
    ...
    }//GEN-LAST:event_calcBtnMouseExited
    ...
    // <= button
    private void delBtnClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_delBtnClicked
        if (alreadyEvaluated) {
    ...
    }//GEN-LAST:event_delBtnClicked

    //digit and dot button clicked event
    private void digitBtnMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_digitBtnMouseReleased
    ...
    }//GEN-LAST:event_digitBtnMouseReleased

    // binary operator clicked event
    private void binOpButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_binOpButtonMouseClicked
        ...
        op = btn.getText();
        updateExpStatus(firstValue, op, secondValue);
    }//GEN-LAST:event_binOpButtonMouseClicked

    private void btnClrMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnClrMouseReleased
        alreadyEvaluated = false;
        op = "";
        secondValue = "";
        firstValue = prepareValueForScreen("0");
        updateScreen(firstValue);
        updateExpStatus("", "", "");
    }//GEN-LAST:event_btnClrMouseReleased

    private void btnToggleMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnToggleMouseReleased
        if (alreadyEvaluated) {
            alreadyEvaluated = false;
            op = "";
            secondValue = "";
    ...
    }//GEN-LAST:event_btnToggleMouseReleased

    private void unaOpMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_unaOpMouseReleased
        if (alreadyEvaluated) {
            alreadyEvaluated = false;
            op = "";
            secondValue = "";
